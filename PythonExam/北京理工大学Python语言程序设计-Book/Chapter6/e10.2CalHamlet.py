    ...
    - 处理
        1. 分解并提取英文文章的单词
            ...
            - 将各种特殊字符和标点符号替换为空格，统一分隔方式，便于提取单词
                - txt.replace()
            - 排除不能代表文章含义的虚词(冠词、代词、介词、连接词等)，用集合类型构建一个排除词汇库
        2. 对每个单词进行计数
            - 将单词保存在变量word中
            - 使用一个字典类型counts={}
...
excludes = {'the', 'and', 'to', 'of', 'you', 'i', 'a', 'my', 'in', 'it', 'that', 'is', 'not',\
            'his', 'this', 'but', 'with', 'for', 'your', 'me', 'be', 'as', 'he', 'what', 'him',\
            'so', 'have', 'will', 'do', 'no', 'we', 'all', 'are', 'on', 'our', 'by', 'shall', 'if',\
            'or', 'o', 'they', 'thou', 'now', 'her', 'from', 'let', 'more', 'good', 'come', 'how', \
            'at', 'thy'}
