"""8.2 借鉴实例15的思路，采用练球规则模拟比赛，分析体育竞技规律，
比较结果与程序练习题8.1的不同
"""
...
def getInputs():
    while True:
        try:
            foulAscore,probA,probA3 = input('请输入 A 队的参\
数(foulAscore,probA,probA3):').split(',')
            foulBscore,probB,probB3 = input("请输入 B 队的参\
数(foulBscore,probB,probB3):").split(',')
